...
# ===========================
    ...
    if base_cur.empty or base_ly.empty:
        ...
        st.line_chart(df_plot.set_index("D")[["Actual","LY"]], height=300)
                ...
                if evo_df.empty:
                    ...
                    adr_chart = (
                        ...
                        .encode(
                            ...
                            color=alt.Color("serie:N",
                                scale=alt.Scale(domain=list(adr_colors.keys()), range=[adr_colors[k] for k in adr_colors]),
                                title=None
                            ),
                    ...
                    chart = alt.layer(occ_chart, adr_chart).resolve_scale(y="independent").properties(height=380)
                    st.altair_chart(chart, use_container_width=True)
