...
def _kai_cdm_pro_analysis(tot_now: dict, tot_ly_cut: dict, tot_ly_final: dict, pace: dict, price_ref_p50: float|None) -> str:
    ...
    lines.append("- Días con **ocupación < objetivo** y **ADR < P50** → subir visibilidad y abrir promos con *fences*.")
    ...
    lines.append("- Priorizar canal directo cuando el **pickup pendiente** sea alto.")
